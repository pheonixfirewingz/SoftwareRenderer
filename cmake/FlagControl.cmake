...
function(flagsSetup)
	if(CMAKE_BUILD_TYPE MATCHES Debug)
		if(CMAKE_CXX_COMPILER_ID MATCHES Clang)
			target_compile_options(${CMAKE_PROJECT_NAME} PRIVATE -W -Werror -Wall -Wextra -march=skylake -Wold-style-cast -fno-common -Wdouble-promotion -Wshadow -Wpedantic -O0 -g3)
			if(!${STATIC_BUILD})
				target_link_options(${CMAKE_PROJECT_NAME} PRIVATE -static-libstdc++)
			 endif()
		elseif(CMAKE_CXX_COMPILER_ID MATCHES GNU)
			 target_compile_options(${CMAKE_PROJECT_NAME} PRIVATE -W -Werror -Wall -Wextra -march=skylake -fno-common -Wdouble-promotion -Wshadow -Wpedantic -O0 -g3)
			 if(!${STATIC_BUILD})
				target_link_options(${CMAKE_PROJECT_NAME} PRIVATE -static-libstdc++)
			 endif()
		elseif(MSVC)
		...
		if(CMAKE_CXX_COMPILER_ID MATCHES Clang)
			target_compile_options(${CMAKE_PROJECT_NAME} PRIVATE -W -Werror -Wall -Wextra -march=skylake -fno-common -Wdouble-promotion -Wshadow -Wpedantic -O2 -g0 -flto -finline-functions)
